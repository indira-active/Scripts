...
var config = {
    url_ext: 'exportFormat=csv&format=csv' // export as pdf / csv / xls / xlsx
        ...
        +
        '&gid=', // the sheet's Id
    dir: DriveApp.getFolderById(""), // Team Drive/Database/Inventory Archives/Vendor
...
function init() {
    ...
    vendors = [];
    // Initializ Suppliers
    var ardenFulfillment = new vendor('Arden Fulfillment', '', 'Internal Inventory', '');
